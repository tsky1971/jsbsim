...
public:
  ...
  // Events
  UPROPERTY(VisibleAnywhere, BlueprintAssignable, Category = "Poperty")
  ...
  *   -Returns a big list, probably should not call often  */
	UFUNCTION(BlueprintCallable, DisplayName = "Property Manager Get Catalog", Category = "Poperty")
  ...
  *     otherwise you will override the system value!*/
	UFUNCTION(BlueprintCallable, DisplayName = "Command Console", Category = "Poperty")
  ...
  *   -InValue of blank/empty if you wish to only lookup a property value,
  *     otherwise you will override the system value! */
	UFUNCTION(BlueprintCallable, DisplayName = "Command Console Batch", Category = "Poperty")
