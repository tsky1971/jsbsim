...
struct FTank
{
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Conditions")
	...
	// Basic Properties
	UPROPERTY(BlueprintReadOnly, VisibleAnywhere, Category = "Basic Properties")
...
struct FEngineCommand
{
  GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Engine Command")
...
struct FEngineState
{
  GENERATED_BODY()
	...
	// Type
	UPROPERTY(BlueprintReadOnly, VisibleAnywhere, Category = "Engine Stats")
