...
#define KNOT_TO_FEET_PER_SEC 1.68781
  ...
  UENUM(BlueprintType)
    enum class EJSBSimEngineType : uint8 {
    Unknown,
    Rocket,
    Piston,
    Turbine,
  ...
  UENUM(BlueprintType)
    enum class EJSBSimMagnetosMode : uint8 {
    Off = 0,
    Left = 1,
    Right = 2,
    Both = 3
  ...
  USTRUCT(BlueprintType)
    struct FJSBSimEngineCommand
  {
    GENERATED_BODY()

    FJSBSimEngineCommand()
    {
    }
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "EngineCommands")
    EJSBSimMagnetosMode Magnetos = EJSBSimMagnetosMode::Off;
    ...
    struct FJSBSimEngineState
  {
    ...
    EJSBSimEngineType EngineType = EJSBSimEngineType::Turbine;
    ...
    UPROPERTY(BlueprintReadOnly, VisibleAnywhere, Category = "EngineState")
    EJSBSimMagnetosMode Magnetos = EJSBSimMagnetosMode::Off; // Piston
    ...
    FString GetDebugMessage()
    {
      ...
      if (EngineType == EJSBSimEngineType::Turbine)
      {
      ...
      if (EngineType == EJSBSimEngineType::Piston)
      {
  ...
  USTRUCT(BlueprintType)
    struct FJSBSimFlightControlCommands
  {
    GENERATED_BODY()

    FJSBSimFlightControlCommands()
    {
    }
  ...
  USTRUCT(BlueprintType)
    struct FJSBSimAircraftState
  {
    GENERATED_BODY()

    FJSBSimAircraftState()
    {
    }
